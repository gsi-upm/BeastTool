...
public class UnderstandingTheCustomer extends BeastTestCase {
    ...
    public void setup() {
         ...
         logger.warning("Implement setup() method in beast.tutorial.jadex.stories.mas.recordAMessageUnderstandingTheCustomer.java -> Auto-generated stub by Beast -> es.upm.dit.gsi.beast-tool");
    ...
    public void launch() {
         ...
         logger.warning("Implement launch() method in beast.tutorial.jadex.stories.mas.recordAMessageUnderstandingTheCustomer.java -> Auto-generated stub by Beast -> es.upm.dit.gsi.beast-tool");
    ...
    public void verify() {
         ...
         logger.warning("Implement verify() method in beast.tutorial.jadex.stories.mas.recordAMessageUnderstandingTheCustomer.java -> Auto-generated stub by Beast -> es.upm.dit.gsi.beast-tool");
    ...
    public void configureScenario(String setupName) {
         ...
         if (setupName.equals("I understand the customer,")){
              setScenario();
         } else {
              logger.severe("WARNING: "+setupName+" does not coincide with I understand the customer,");
         }
    }
    ...
    public void checkScenario(String evaluationName) {
        ...
        if (evaluationName.equals("I record his/her message and I send that FIPA-INFORM message to a ReporterAgent.")){
            this.setExecutionTime(BeastTestCase.SLEEP_TIME);
            verify();
        } else {
            logger.severe("WARNING: "+evaluationName+" does not coincide with I record his/her message and I send that FIPA-INFORM message to a ReporterAgent.");
        }
    }
