...
public class MisunderstandingTheCustomer extends BeastTestCase {
	...
	public void setup() {
		...
		when(
				myMockedBehaviour.processMessage(eq(SFipa.REQUEST),
		...
		mock_configuration.setDFServiceName("helpdesk-service");
		mock_configuration.setBehaviour(myMockedBehaviour);
		MockManager.startMockJadexAgent("HelpDeskMockAgent",
				Definitions.JADEX_REPOSITORY_MOCK_PATH, mock_configuration,
				this);
