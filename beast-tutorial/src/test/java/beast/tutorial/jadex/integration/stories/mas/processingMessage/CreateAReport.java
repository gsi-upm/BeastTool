package beast.tutorial.jadex.integration.stories.mas.processingMessage;
...
public class CreateAReport extends BeastTestCase {
    ...
    public void setup() {
         ...
         logger.warning("Implement setup() method in beast.tutorial.jadex.integration.stories.mas.processingMessageCreateAReport.java -> Auto-generated stub by Beast -> es.upm.dit.gsi.beast-tool");
    ...
    public void launch() {
         ...
         logger.warning("Implement launch() method in beast.tutorial.jadex.integration.stories.mas.processingMessageCreateAReport.java -> Auto-generated stub by Beast -> es.upm.dit.gsi.beast-tool");
    ...
    public void verify() {
         ...
         logger.warning("Implement verify() method in beast.tutorial.jadex.integration.stories.mas.processingMessageCreateAReport.java -> Auto-generated stub by Beast -> es.upm.dit.gsi.beast-tool");
