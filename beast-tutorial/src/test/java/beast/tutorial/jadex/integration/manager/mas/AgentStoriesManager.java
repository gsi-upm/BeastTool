package beast.tutorial.jadex.integration.manager.mas;
...
public class AgentStoriesManager {
  ...
  public void processingMessage() {
      Result result = JUnitCore.runClasses(beast.tutorial.jadex.integration.stories.mas.ProcessingMessage.class);
  ...
  public void recordAMessage() {
      Result result = JUnitCore.runClasses(beast.tutorial.jadex.integration.stories.mas.RecordAMessage.class);
      Assert.assertTrue(result.wasSuccessful());
  }
  ...
  public void passingAnIncomingCall() {
      Result result = JUnitCore.runClasses(beast.tutorial.jadex.integration.stories.mas.PassingAnIncomingCall.class);
      Assert.assertTrue(result.wasSuccessful());
  }
