package beast.tutorial.jade.integration.stories.mas;
...
public class RecordAMessage{
   ...
   */
    ...
    public void understandingTheCustomer() {
        BeastTestCaseRunner.executeBeastTestCase("beast.tutorial.jade.integration.stories.mas.recordAMessage.UnderstandingTheCustomer");
    }
  /**
   ...
   */
    ...
    public void misunderstandingTheCustomer() {
        BeastTestCaseRunner.executeBeastTestCase("beast.tutorial.jade.integration.stories.mas.recordAMessage.MisunderstandingTheCustomer");
    }
