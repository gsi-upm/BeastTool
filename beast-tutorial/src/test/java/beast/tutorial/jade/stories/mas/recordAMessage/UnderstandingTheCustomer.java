...
public class UnderstandingTheCustomer extends BeastTestCase {
    ...
    public void launch() {
         ...
         logger.warning("Implement launch() method in beast.tutorial.jade.stories.mas.recordAMessageUnderstandingTheCustomer.java -> Auto-generated stub by Beast -> es.upm.dit.gsi.beast-tool");
    ...
    public void verify() {
         ...
         logger.warning("Implement verify() method in beast.tutorial.jade.stories.mas.recordAMessageUnderstandingTheCustomer.java -> Auto-generated stub by Beast -> es.upm.dit.gsi.beast-tool");
