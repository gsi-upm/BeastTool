...
public class PassACall extends BeastTestCase {
    ...
    public void setup() {
        ...
        when(myMockedBehaviour.processMessage(eq(ACLMessage.getPerformative(ACLMessage.INFORM)),eq("BeastMessenger"),eq("sendRequest")))
            .thenReturn("helpdesk-service", ACLMessage.getPerformative(ACLMessage.REQUEST), "UnknownLanguageCall");
        ...
        startAgent("HelpDeskAgentUnderTesting", "beast.tutorial.jade.agent.HelpDeskAgent");
