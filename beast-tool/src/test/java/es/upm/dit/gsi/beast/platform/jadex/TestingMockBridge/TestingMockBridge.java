package es.upm.dit.gsi.beast.platform.jadex.TestingMockBridge;
 ...
 */
  public class TestingMockBridge extends Story {

     public Logger logger = Logger.getLogger(TestingMockBridge.class.getName());
  /**
   * Constructor to configure logging
   */
  public TestingMockBridge() {
     ...
     try {
         ...
         LogActivator.logToFile(logger, TestingMockBridge.class.getName(), Level.ALL);
