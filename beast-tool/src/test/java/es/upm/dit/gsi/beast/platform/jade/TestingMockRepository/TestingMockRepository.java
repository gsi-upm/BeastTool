...
public class TestingMockRepository extends BeastTestCase {
    ...
    public Logger logger = Logger.getLogger(TestingMockRepository.class
            .getName());
    ...
    public TestingMockRepository() {
        ...
        try {
            ...
            LogActivator.logToFile(logger,
                    TestingMockRepository.class.getName(), Level.ALL);
    ...
    public void createScenario(String scenarioName) {
        ...
        if (scenarioName
                .equals("one bridge mock and one repository mock in Jade Platform")) {
            startPlatform("jade", logger);
        } else {
            logger.severe("WARNING: "
                    + scenarioName
                    + " does not coincide with one bridge mock and one repository mock in Jade Platform");
        }
    }
    ...
    public void configureScenario(String setupName) {
        ...
        if (setupName.equals("bridge sends a message to repository")) {
            ...
            logger.severe("WARNING: "
                    + setupName
                    + " does not coincide with bridge sends a message to repository");
        }
    }
    ...
    public void checkScenario(String evaluationName) {
        ...
        if (evaluationName
                .equals("repository answers with the correct message")) {
            verify();
        } else {
            logger.severe("WARNING: "
                    + evaluationName
                    + " does not coincide with repository answers with the correct message");
        }
    }
