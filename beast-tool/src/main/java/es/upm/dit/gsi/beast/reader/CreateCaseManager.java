...
public class CreateCaseManager {
	...
	public static File startCaseManager(String package_path, String dest_dir){
		...
		try {
			...
			caseManagerWriter.write("import es.upm.dit.gsi.beast.story.StoryRunner;\n"); // import StoryRunner
			caseManagerWriter.write("\n");
			caseManagerWriter.write("/**\n");
	...
	public static void createTest(File caseManager, String test_name, String test_path, String scenario, String given, String when, String then) {
		...
		try {
			...
			caseManagerWriter.write("   * where the GIVEN is described as: "+given+",\n");
			caseManagerWriter.write("   * the WHEN is described as: "+when+"\n");
			caseManagerWriter.write("   * and the THEN is described as: "+then+"\n");
			caseManagerWriter.write("   */\n");
			caseManagerWriter.write("  @Test\n");
			caseManagerWriter.write("  public void Scenario"+test_name+"() {\n");
			caseManagerWriter.write("  \n");
			caseManagerWriter.write("	  StoryRunner.executeStory(\""+test_path+"\");\n");
			caseManagerWriter.write("  }\n");
			caseManagerWriter.write("\n");
			caseManagerWriter.flush();
			caseManagerWriter.close();
	 ...
	 * It is called just one time, by Reader.java.
	 * 
	 * @param caseManager
	 */
	...
	public static void closeCaseManager(File caseManager) {
		...
		try {
			...
			Logger logger = Logger.getLogger("CreateCaseManager.closeCaseManager");
